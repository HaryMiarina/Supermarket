...
// Definir la base dynamique
$basepath = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/');

// fonction globale pour créer une URL propre
function url(string $path = '') {
    global $basepath;
    return $basepath . '/' . ltrim($path, '/');
}

// fonction globale pour assets (images/css/js)
...
// Register application paths for class autoloading
Flight::path(__DIR__ . $ds . '..' . $ds . 'controllers');
Flight::path(__DIR__ . $ds . '..' . $ds . 'models');
Flight::path(__DIR__ . $ds . '..' . $ds . 'middlewares');
